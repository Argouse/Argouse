import { reportDOMupdate, reportButtonClick, reportTextUpdate } from "./structureMethods"
 ...
 * @author iiijr
 */
export function domActionListen() {
  let targetNode = document.querySelector("body");
  // subtree：是否监听子节点的变化
  const config = {
    attributes: true,
